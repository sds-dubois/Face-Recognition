...
dist_leye,var_leye = evalMatrix('../allFeatures/yale_face_db/training/leye_features.csv')
dist_reye,var_reye = evalMatrix('../allFeatures/yale_face_db/training/reye_features.csv')
dist_mouth,var_mouth = evalMatrix('../allFeatures/yale_face_db/training/mouth_features.csv')
dist_nose,var_nose = evalMatrix('../allFeatures/yale_face_db/training/nose_features.csv')
